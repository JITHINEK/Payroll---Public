				...
				<div class="colorlib-narrow-content">
					...
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						<div class="about-desc">
							...
							<p>Employee id: <input type="text" value="<% out.println(id1); %>" name="id"></p>
				...
				<div class="panel panel-default">
					...
					<div id="collapseThree" class="panel-collapse collapse"
						...
						<div class="panel-body">
							...
							<p>City: <input type="text" value="<%out.println(addr); %>" name="city"></p>
							<p>State: <input type="text" value="<%out.println(addr); %>" name="state"></p>
							<p>Pincode: <input type="text" value="<% out.println(pin); %>" name="pin"></p>
							<p>Mobile No: <input type="text" value="<% out.println(email_id); %>" name="mob"></p>
