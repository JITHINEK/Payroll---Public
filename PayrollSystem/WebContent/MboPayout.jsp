...
<body>
	<div id="colorlib-page">
		...
		<ul>
			...
			<br>
			<li class="colorlib-active"><a href="Payroll.jsp">MBO Payout</a></li>
			<br>
			<br>
			...
			<form action="MboPayout" method="post">
				...
				<!-- <table align='center' cellspacing=2 cellpadding=5 id=\"data_table\"border=1>
					<div class="row" style="width: 250px; display: block; margin-bottom: 10px;">
					      <div class="col-sm-2" style="width: 250px;  margin-bottom: 50px;">	
						Month:</div><div class="col-sm-2" style="width: 250px;  margin-bottom: 50px;">	<select name="month"
					...
					<div class="col-sm-2" style="width: 250px; display: ; margin-bottom: 10px;">
